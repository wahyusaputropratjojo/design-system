...
function SliderThumb({ ...props }: SliderThumbProps) {
  return (
    <SliderThumbPrimitive
      className="top-1/2 left-1/2 rounded-full bg-white shadow-xl focus-visible:outline-3 focus-visible:outline-offset-2 group-orientation-horizontal:h-6 group-orientation-vertical:h-10 group-orientation-horizontal:w-10 group-orientation-vertical:w-6"
      {...props}
    />
  );
}
...
function SliderFill({ ...props }: SliderFillProps) {
  ...
  return (
    <div
      className="group-orientation-horizontal/top-0 pointer-events-none absolute rounded-full bg-primary-9 group-disabled/track:opacity-60 group-orientation-vertical/track:bottom-0 group-orientation-horizontal/track:h-full group-orientation-vertical/track:w-full"
      style={getFill()}
      {...props}
    />
  );
...
export function SliderTrack({ ...props }: SliderTrackProps) {
  return (
    <SliderTrackPrimitive
      className="group/track relative grow rounded-full bg-neutral-9 disabled:opacity-60 group-orientation-vertical:my-5 group-orientation-horizontal:h-1.5 group-orientation-horizontal:w-full group-orientation-vertical:w-1.5 group-orientation-vertical:flex-1"
      {...props}
    />
  );
}
